 ...
 * Name: Russell Tan
 * Class: CECS274
 * Description: This class calculates if a number is happy by adding 
 * the digits to a list then it uses another method to square each digit
 * then it uses a sum method to add the results 
 * and finally it recursively checks if the number is happy which means
 * it converges on 1
 */
import java.util.*;

public class happyNumberCalc 
{
	//Default constructor
	happyNumberCalc(){}
