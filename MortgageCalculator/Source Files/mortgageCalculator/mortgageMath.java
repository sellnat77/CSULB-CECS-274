 ...
 *ID         : 011529945
 *Class      : CECS 274
 *Description: This is the class that performs all of the calculations
 *             for a mortgage loan
 */
package mortgageCalculator;

public class mortgageMath 
{
	//Default constructor
	mortgageMath(){}
	
	//Full constructor that assigns the appropriate values 
	//when instantiated with an integer and two doubles
	mortgageMath(int A, double B, double C)
	{
		loanTerm     = A;
		theMortgage  = B;
		interestRate = C;
